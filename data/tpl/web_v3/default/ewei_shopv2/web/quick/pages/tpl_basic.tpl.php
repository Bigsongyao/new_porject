<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group">
    <label class="col-lg control-label must">页面标题</label>
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('quick.pages' ,$item) ) { ?>
            <input type="text" name="title" class="form-control" value="<?php  echo $item['title'];?>" data-rule-required="true" id="pagetitle" />
        <?php  } else { ?>
