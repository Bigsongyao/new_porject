...
<div class="form-horizontal" id="js-cloud-diagnose" ng-controller="CloudDiagnoseCtrl" ng-cloak>
	<h5 class="page-header">系统云服务状态诊断</h5>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			...
			<div class="help-block">请查看您的站点ID和通信密钥, 需要保证与<a href="<?php  echo url('cloud/profile');?>" class="STYLE1">系统云平台记录</a>的值一致, 否则不能正常使用系统云平台的各项服务. </div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			...
			<div class="help-block">如果您的站点ID和通信密钥与您绑定的站点信息中的记录不一致, 或访问系统云服务失败并多次重试后无效时. 请点击重置按钮, 重新注册您的站点信息！ </div>
		</div>
	</div>

	<h5 class="page-header">系统云服务网络诊断</h5>
	<div class="form-group">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">系统云平台域名解析</label>
		<div class="col-sm-10 js-checkip">
			<?php  if(is_array($checkips)) { foreach($checkips as $index => $ip) { ?>
				<p class="form-control-static">系统云节点<?php  echo $index+1;?>：<span id="serverdnsip"><?php  echo $ip;?></span>; 速率测试：<span class="form-control-static" id="checkresult">检测中...</span></p>
			<?php  } } ?>
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label">绑定系统云服务IP</label>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">系统云平台链接测试</label>
		<div class="col-sm-10">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">设置系统云服务ip地址</h4>
			</div>
			<div class="modal-body">
				<div class="form-group">
					<label class="control-label col-xs-3">系统云服务ip</label>
					<div class="col-xs-9">
						<input type="text" class="form-control" name="ip" value="<?php  echo $_W['setting']['cloudip']['ip'];?>" />
						<span class="help-block">如果您解析的系统云服务ip异常，可以在此手动设置</span>
					</div>
				</div>
			</div>
