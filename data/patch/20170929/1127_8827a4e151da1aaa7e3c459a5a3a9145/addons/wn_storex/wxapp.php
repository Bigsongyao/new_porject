...
class Wn_storexModuleWxapp extends WeModuleWxapp
{
	...
	function actions($ac)
	{
		$actions = array('homePageList' => array('do' => 'wxapphomepage', 'op' => 'display'), 'homePageNotice' => array('do' => 'wxapphomepage', 'op' => 'notice'), 'storeList' => array('do' => 'store', 'op' => 'store_list'), 'storeDetail' => array('do' => 'store', 'op' => 'store_detail'), 'storeComment' => array('do' => 'store', 'op' => 'store_comment'), 'categoryClass' => array('do' => 'category', 'op' => 'class'), 'categorySub' => array('do' => 'category', 'op' => 'sub_class'), 'moreGoods' => array('do' => 'category', 'op' => 'more_goods'), 'goodsSearch' => array('do' => 'category', 'op' => 'goods_search'), 'specInfo' => array('do' => 'goods', 'op' => 'spec_info'), 'goodsInfo' => array('do' => 'goods', 'op' => 'goods_info'), 'goodsBuyInfo' => array('do' => 'goods', 'op' => 'info'), 'goodsOrder' => array('do' => 'goods', 'op' => 'order'), 'creditGoodsList' => array('do' => 'goods', 'op' => 'display'), 'creditGoodsDetail' => array('do' => 'goods', 'op' => 'detail'), 'creditGoodsExchange' => array('do' => 'goods', 'op' => 'exchange'), 'creditGoodsMine' => array('do' => 'goods', 'op' => 'mine'), 'creditMineConfirm' => array('do' => 'goods', 'op' => 'confirm'), 'getUserInfo' => array('do' => 'usercenter', 'op' => 'personal_info'), 'updateUserInfo' => array('do' => 'usercenter', 'op' => 'personal_update'), 'addressLists' => array('do' => 'usercenter', 'op' => 'address_lists'), 'deleteAddress' => array('do' => 'usercenter', 'op' => 'address_delete'), 'defaultAddress' => array('do' => 'usercenter', 'op' => 'address_default'), 'addressInfo' => array('do' => 'usercenter', 'op' => 'current_address'), 'editAddress' => array('do' => 'usercenter', 'op' => 'address_post'), 'userCredits' => array('do' => 'usercenter', 'op' => 'credits_record'), 'extend' => array('do' => 'usercenter', 'op' => 'extend_switch'), 'creditPassword' => array('do' => 'usercenter', 'op' => 'credit_password'), 'checkPasswordLock' => array('do' => 'usercenter', 'op' => 'check_password_lock'), 'setCreditPassword' => array('do' => 'usercenter', 'op' => 'set_credit_password'), 'footer' => array('do' => 'usercenter', 'op' => 'footer'), 'orderPay' => array('do' => 'orders', 'op' => 'orderpay'), 'orderList' => array('do' => 'orders', 'op' => 'order_list'), 'orderInfo' => array('do' => 'orders', 'op' => 'order_detail'), 'orderComment' => array('do' => 'orders', 'op' => 'order_comment'), 'orderCancel' => array('do' => 'orders', 'op' => 'cancel'), 'orderConfirm' => array('do' => 'orders', 'op' => 'confirm_goods'), 'cardRecharge' => array('do' => 'recharge', 'op' => 'card_recharge'), 'rechargeAdd' => array('do' => 'recharge', 'op' => 'recharge_add'), 'rechargePay' => array('do' => 'recharge', 'op' => 'recharge_pay'), 'signInfo' => array('do' => 'sign', 'op' => 'sign_info'), 'signSing' => array('do' => 'sign', 'op' => 'sign'), 'remedySign' => array('do' => 'sign', 'op' => 'remedy_sign'), 'signRecord' => array('do' => 'sign', 'op' => 'sign_record'), 'noticeList' => array('do' => 'notice', 'op' => 'notice_list'), 'noticeRead' => array('do' => 'notice', 'op' => 'read_notice'), 'receiveCard' => array('do' => 'membercard', 'op' => 'receive_card'), 'receiveInfo' => array('do' => 'membercard', 'op' => 'receive_info'), 'couponList' => array('do' => 'coupon', 'op' => 'display'), 'couponExchange' => array('do' => 'coupon', 'op' => 'exchange'), 'myCoupon' => array('do' => 'coupon', 'op' => 'mine'), 'couponInfo' => array('do' => 'coupon', 'op' => 'detail'), 'wxAddCard' => array('do' => 'coupon', 'op' => 'addcard'), 'wxOpenCard' => array('do' => 'coupon', 'op' => 'opencard'), 'creditCouponList' => array('do' => 'coupon', 'op' => 'display'), 'creditCouponDetail' => array('do' => 'coupon', 'op' => 'detail'), 'clerkPermission' => array('do' => 'clerk', 'op' => 'permission_storex'), 'clerkOrder' => array('do' => 'clerk', 'op' => 'order'), 'clerkOrderInfo' => array('do' => 'clerk', 'op' => 'order_info'), 'clerkOrderEdit' => array('do' => 'clerk', 'op' => 'edit_order'), 'clerkRoom' => array('do' => 'clerk', 'op' => 'room'), 'clerkRoomInfo' => array('do' => 'clerk', 'op' => 'room_info'), 'clerkRoomEdit' => array('do' => 'clerk', 'op' => 'edit_room'));
		if (!empty($actions[$ac])) {
			return $actions[$ac];
		}
	...
	public function doPageLocation()
	{
		global $_GPC;
		load()->func('communication');
		$params = array('coordtype' => 'gcj02ll', 'pois' => 0, 'output' => json, 'ak' => !empty($_GPC['ak']) ? $_GPC['ak'] : 'WYABRjaoGklLEcobdrl2erIGvOpT4toj', 'sn' => '', 'timestamp' => '', 'ret_coordtype' => 'gcj02ll', 'location' => $_GPC['location']);
	...
	public function doPagePay()
	{
		...
		if ($order_type == 'recharge') {
			...
			$order = array('tid' => $order_info['tid'], 'user' => $_SESSION['openid'], 'fee' => floatval($order_info['fee']), 'title' => "余额充值" . $order_info['fee']);
		} else {
			$order_info = pdo_get('storex_order', array('id' => $orderid), array('id', 'sum_price', 'style'));
			$condition['tid'] = $order_info['id'];
			$order = array('tid' => $orderid, 'user' => $_SESSION['openid'], 'fee' => floatval($order_info['sum_price']), 'title' => $order_info['style']);
		}
		if (empty($order_info)) {
		...
		if ($order_type == 'recharge') {
			...
			if (!empty($storex_bases['phones'])) {
				...
				foreach ($storex_bases['phones'] as $phone) {
					cloud_prepare();
					$body = 'df';
					$body = '用户' . $order['name'] . ',电话:' . $order['mobile'] . '于' . date('m月d日H:i') . '成功支付万能小店订单' . $order['ordersn'] . ',总金额' . $order['sum_price'] . '元' . '.' . random(3);
