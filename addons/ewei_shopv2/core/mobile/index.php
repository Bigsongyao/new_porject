...
class Index_EweiShopV2Page extends MobilePage 
{
    ...
    $hot_goods = pdo_fetchall('select id, title, subtitle, thumb, marketprice,ispresell,presellprice, productprice, minprice, total from ' . tablename('ewei_shop_goods') . ' where uniacid=:uniacid and ishot=1 and status=1 order by displayorder desc limit 2', array(':uniacid' => $uniacid));
