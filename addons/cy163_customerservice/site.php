...
//淘宝大众乐科技 https://shop504817250.taobao.com/shop/view_shop.htm
...
class Cy163_customerserviceModuleSite extends WeModuleSite
{
	...
	public function doMobileServicechat()
	{
		...
		if (!empty($fansinfo)) {
			...
			$memberaddress = pdo_fetch("SELECT * FROM " . tablename('mc_member_address') . " WHERE uid = {$fansinfo['uid']} ORDER BY isdefault DESC,id DESC");
		} else {
			$fansmember = '';
		}
